...
const ConfigFieldRow = ({ field, sIndex, fIndex, onUpdate, onToggle, onPickPath }: ConfigFieldRowProps) => {
  ...
  return (
    <div className="group flex flex-col px-4 md:flex-row md:items-center justify-between gap-4 py-4 border-b border-border/40 last:border-0 hover:bg-muted/5 transition-colors">
